      ...
      <div className="aside_about_container">
        <aside id="left">
          ...
          <section className="card_container">
            <p>
              Ce site a pour but de me présenter brièvement et de référencer
              tous mes projets. Il sera régulièrement mis à jour, et évoluera au
              rythme de mon acquisition de compétences. <br />
              Je m'appelle Aurélien Brethes, j'ai 30 ans, et je suis
              actuellement en stage dans l'entreprise{" "}
              <a href="https://digitalcopilote-website.vercel.app/">
                Digital Copilote
              </a>{" "}
              suite à ma formation de développeur web et web mobile au sein de
              la{" "}
              <a href="https://www.wildcodeschool.com/fr-FR">
                Wild Code School de Biarritz
              </a>
              . De technicien en électronique à technico-commercial, j'ai passé
              les 10 premières années de ma vie professionnelle à chercher ma
              voie, accumulant les expériences, aussi variées que formatrices.
              Attiré depuis toujours par le numérique, la programmation et les
              nouvelles technologies, et après plus d'un an de travail en
              autodidacte, j'ai décidé de rejoindre une formation sérieuse dans
              une école renommée afin de compléter mes connaissances pour me
              lancer à 100% dans ma reconversion. <br />
              Terminant mon stage fin Juin, je suis actuellement à la recherche
              d'un poste en CDD ou CDI à partir de début Juillet.
            </p>
          </section>
        </aside>
        <aside id="right">
          ...
          <p id="inspi_intro">
            Parce que je suis persuadé que nous sommes façonnés par celles et
            ceux qui nous entourent, voici quelques-unes des nombreuses
            personnes qui m'inspirent au quotidien, et qui, quelque part,
            représentent des valeurs qui me caractérisent
          </p>
          <section className="inspi_container">
            <div id="inspi_header">
              <h3>{inspirations[index].people}</h3>
              <div id="span_container">
                <button className="span" onClick={() => decrement()}>
                  {"<"}
                </button>
                <button className="span" onClick={() => increment()}>
                  {">"}
                </button>
              </div>
