    ...
    <div className="about_container" id="about">
      ...
      <section className="card_container">        
        <p>Ce site a pour but de me présenter brièvement et de référencer tous mes projets. Il sera régulièrement mis à jour, et évoluera au rythme de mon acquisition de compétences. <br />
          ...
          Attiré depuis toujours par le numérique, la programmation et les nouvelles technologies, et après plus d'un an de travail en autodidacte, j'ai décidé de rejoindre une formation sérieuse dans une école renommée afin de compléter mes connaissances pour me lancer à 100% dans ma reconversion.
        </p>
        <a href="#stage">
      ...
      <span className="card_container" id="stage">
        Dans le cadre de mon évolution professionnelle, je suis actuellement à la recherche d'un stage à partir du 14 Février 2022 en remote, ou en présentiel sur le secteur 40/64.
      </span>  
    </div>
  );
}
