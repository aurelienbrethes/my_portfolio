...
function Carousel() {
  ...
  const myProjects = [
    {titre : "Cogebois", image : cogebois , tech : "no-code, wordpress", description : "Site vitrine pour une entreprise de construction de maisons bois. Réalisé en no-code avec Wordpress ( et le template Avada ). Optimisé SEO à la demande du client"},
