...
function Projects() {
  ...
  const myProjects = [
    ...
    { titre : "Blind Crash Test", image : bct, link : "https://marie5060.github.io/Blind-Crash-Test/", tech :"React.js", description : "Première expérience avec React.js, le but était de créer un site en utilisant l'appel à un API. Nous avons choisi celui de Deezer et avons codé notre propre Blind-test."},
    { titre : "Live Up", image : liveup, link : "https://aurelienbrethes.github.io/Liveup/", tech :"React.js, mySQL", description : "Live Up est le fruit de notre premier Hackathon. En groupe de 6, nous devions créer un site sur le thème de la musique en seulement 30h (sans sommeil évidemment). Nous avons conçu ce projet pour permettre à des utilisateurs en quête d'évènements musicaux proches de chez eux de trouver rapidement ce que proposent organisateurs les plus proches. Site réalisé avec React.js avec création de notre propre API. La limite de temps imposée explique que le site n'est pas terminé, et que la propreté du code laisse à désirer sur certaines parties. Nous feront mieux au prochain ! "},
  ]
  return (
